...
export const Careers = () => {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-white relative overflow-hidden pt-2">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.h1 
          ...
          className="text-5xl md:text-7xl font-bold text-black font-figtree mb-6 tracking-tight"
        >
          Join Our <span className="text-xentek-accent italic font-serif">Team</span>
        </motion.h1>
        ...
        <motion.p 
          ...
          className="text-lg md:text-xl text-gray-600 font-figtree mb-12 max-w-2xl mx-auto leading-relaxed"
        >
        ...
        >
          <div className="flex items-center gap-3 px-8 py-4 bg-white/5 border border-black border-2 rounded-full backdrop-blur-sm">
            <Rocket className="w-5 h-5 text-xentek-accent" />
            <span className="text-gray-600 font-figtree font-medium tracking-wide">Portal Coming Soon</span>
          </div>
